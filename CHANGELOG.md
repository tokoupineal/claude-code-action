...
## Fork Changes (tokoupineal/claude-code-action@beta)
...
- **Updated Base Action**: Uses `tokoupineal/claude-code-base-action@beta` which includes OAuth credential handling
